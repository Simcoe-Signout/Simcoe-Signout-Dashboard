...
import { bookingsStore } from './BookingsService';
import { categoriesStore } from './CategoriesService';
...
export const resourcesPageStore = defineStore({
    id: 'resources',
    state: () => ({
        api_uri: `${import.meta.env.MODE === 'development' ? 'http://127.0.0.1:3000' : import.meta.env.MODE === 'staging' ? 'https://stgapi.simcoesignout.com' : 'https://api.simcoesignout.com'}/api/core/resources`,
        admin_api_uri: `${import.meta.env.MODE === 'development' ? 'http://127.0.0.1:3000' : import.meta.env.MODE === 'staging' ? 'https://stgapi.simcoesignout.com' : 'https://api.simcoesignout.com'}/api/admin/resources`,
        categories: [
            'Category 1',
            'Category 2',
        ],
